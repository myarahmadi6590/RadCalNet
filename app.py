...
from db_plot         import show_image, get_plot_style, polar_angle_plot, plot_matchup_count, plot_mean_ratio_per_instrument, plot_mean_ratio_per_site, time_series_plot, average_plot, sensitivity_plot
...
with left_sidebar: sensor_colors, site_symbols = get_plot_style(df_dct)
with left_sidebar: plot_matchup_count(stat_dct, sensor_colors)
with right_sidebar: show_image (sites_config, condition, df_dct)
...
with mainbar: average_plot (sensors_config, condition, stat_dct, sensor_colors)
with mainbar: sensitivity_plot(sensors_config, condition, df_dct, sensor_colors, site_symbols)
